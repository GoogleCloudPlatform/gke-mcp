...
description: >-
  Diagnoses novel or complex GKE issues and dynamically generates specialized
  troubleshooting skills. Make sure to trigger this skill whenever the user faces
  a complex, non-obvious GKE problem or standard troubleshooting fails, even if
  they don't explicitly ask to create a skill.
---
...
-   Use the
    ...
    template.
-   **Cheatsheet Philosophy**: Write the `SKILL.md` to be terse and opinionated.
